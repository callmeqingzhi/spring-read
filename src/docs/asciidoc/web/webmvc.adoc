...
----
	@RequestMapping("/")
	public String handle(**@SessionAttribute** bean.User user) {
		// ...
	}
----
...
----
	...
	public class UserController {
		...
		@GetMapping("/user")
		@JsonView(bean.User.WithoutPasswordView.class)
		public bean.User getUser() {
			return new bean.User("eric", "7!jd#h23");
		}
	}

	public class bean.User {
		...
		public bean.User(String username, String password) {
...
----
	...
	public class UserController extends AbstractController {
		...
		public String getUser(Model model) {
			model.addAttribute("user", new bean.User("eric", "7!jd#h23"));
			model.addAttribute(JsonView.class.getName(), bean.User.WithoutPasswordView.class);
			return "userView";
		}
	}
----
